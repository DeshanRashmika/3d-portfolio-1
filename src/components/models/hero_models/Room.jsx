...
export function Room(props) {
  const { nodes, materials } = useGLTF(assetPath("/models/optimized-room.glb"));
  const screensRef = useRef();
  const matcapTexture = useTexture(assetPath("/images/textures/mat1.png"));
...
useGLTF.preload(assetPath("/models/optimized-room.glb"));
