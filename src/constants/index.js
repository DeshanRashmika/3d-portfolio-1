...
const expCards = [
  {
    ...
    responsibilities: [
      "Designed and developed 10+ RESTful API endpoints using Spring Boot and Hibernate / JPA,optimizing database query latency and ensuring seamless data pipelines for third-party integrations.",
